<template>
    <div>
         <head>
    <meta charset="UTF-8">
   <!-- <title> Responsive Contact Us Form  | adhyapana </title>-->
    ...
    <div class="content">
      <div class="left-side">
        ...
        <div class="phone details">
          ...
          <div class="text-two">+0000 0000 0001</div>
        </div>
        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div>
          <div class="text-one">adhyapana@gmail.com</div>
          <div class="text-two">info.adhyapana@gmail.com</div>
        </div>
      </div>
      <div class="right-side">
        <div class="topic-text">Send us a message</div>
        <p>If you have any type of queries. Please do contact us we will be haapy to help!</p>
